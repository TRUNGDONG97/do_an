...
export class UserScreen extends Component {
      ...
      >
        <Text
          style={[
            ...
            { flex: 1, color: theme.colors.primaryText }
          ]}
        >
          {field}
        </Text>
        <Text
          style={[
            theme.fonts.regular15,
            { flex: 2, paddingLeft: 15, textAlign: "right" }
          ]}
          numberOfLines={1}
        >
          {info}
  ...
  _renderOption(title, onPress) {
    return (
      ...
      >
        <Text
          style={[theme.fonts.regular15, { color: theme.colors.primaryText }]}
        >
          {title}
        </Text>
        <Icon.Entypo
            ...
            <Block style={{ flex: 1, marginLeft: 15 }}>
              ...
              >
                <Text
                  ...
                  numberOfLines={1}
                >
                  {UserInfoState.data.first_name +
                    " " +
                    UserInfoState.data.last_name}
                </Text>
                <FastImage
              ...
              <Text
                style={[
                  theme.fonts.bold16,
                  { color: theme.colors.black2, flex: 1, marginTop: 5 }
                ]}
              >
