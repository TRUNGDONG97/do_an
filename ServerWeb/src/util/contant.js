...
const TIME_WORKING={
    ...
    TIME_START_WORKING_AFTERNOON:13*60+30,//thởi gian bắt đầu làm việc vào buổi chiều 13:30
...
const TIMEKEEPING={
    ...
    TIME_START_CHECKOUT_AFTERNOON:17*60+30, //thời gian bắt đầu checkout  buổi CHIỀU 17h 
    TIME_END_CHECKOUT_AFTERNOON:23*60, //thời gian kết checkout  buổi CHIỀU 24:00
}
export default {
    OPTION,
    PER_PAGE,
