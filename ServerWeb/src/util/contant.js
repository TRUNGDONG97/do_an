...
const DISTANCE=250
const TIME_WORKING={
    TIME_START_WORKING_MORNING:12*60+30,//thởi gian bắt đầu làm việc vào buổi sáng 8:30
...
const TIMEKEEPING={
    ...
    TIME_END_CHECKIN_MORNING:9*60, //thời gian kết thúc checkin  buổi sáng 6h 
    ...
    TIME_START_CHECKIN_AFTERNOON:23*60, //thời gian bắt đầu checkin  buổi CHIỀU 12h 
    TIME_END_CHECKIN_AFTERNOON:24*60-1, //thời gian kết thúc checkin  buổi CHIỀU 14h
    TIME_START_CHECKOUT_AFTERNOON:23*60+30, //thời gian bắt đầu checkout  buổi CHIỀU 17h 
